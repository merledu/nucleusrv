	  ...
	  # echo statement.
        ...
        # variable which will be set in runTests function
            ...
            # set up the simulation command. Template is for spike. Please change.
                simcmd = f"python3 /home/hassan/nucleusrv/tools/trace/scripts/logToSignature.py --log {testentry['work_dir']}/nucleusrv.log --disass {testentry['work_dir']}/nucleusrv.disass --signature {testentry['work_dir']}/nucleusrv.signature"
