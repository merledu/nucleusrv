	  ...
	  # echo statement.
        ...
        # variable which will be set in runTests function
            ...
            # set up the simulation command. Template is for spike. Please change.
                ...
                A = f"python3 /home/hassan/Documents/nucleusrv/tools/trace/scripts/assemblyParser.py --asm {testentry['work_dir']}/nucleusrv.disass --hex {testentry['work_dir']}/nucleusrv.hex"
                AA = f"python3 /home/hassan/nucleusrv/tools/trace/scripts/hex_cleaner.py --hex {testentry['work_dir']}/nucleusrv.hex"
                B = f"cd "
                C = "cd Documents/nucleusrv"
                E = 'make sim IMEM={0}/nucleusrv.hex'.format(testentry['work_dir'])
                F = f"cd ./tools/trace"
                G = f"echo Generating log..."
                H = "python3 /home/hassan/Documents/nucleusrv/tools/trace/scripts/sbtToLog.py --asm {}/nucleusrv.disass --sbt_dump /home/hassan/Documents/nucleusrv/trace.log --log {}/nucleusrv.log".format(testentry['work_dir'], testentry['work_dir'], testentry['work_dir'])
