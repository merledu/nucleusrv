...
`endif // RANDOMIZE_REG_INIT
  ...
  sram_top #(.IFILE_IN("pong.hex")) sram ( // @[SRamTop.scala 33:22]
    .clk_i(sram_clk_i),
    .clk_pixel_i(sram_clk_pixel_i),
    .rst_i(sram_rst_i),
    .csb_i(sram_csb_i),
    .we_i(sram_we_i),
  ...
  assign sram_clk_pixel_i = clk_pixel;
  ...
  assign sram_addr_i = io_req_bits_addrRequest;
...
module Top(
  ...
  assign dmem_clk_pixel = clk_pixel;
  ...
  assign imem_clk_pixel = clk_pixel;
