	  ...
	  # echo statement.
        ...
        # variable which will be set in runTests function
            ...
            # set up the simulation command. Template is for spike. Please change.
                simcmd = f"python3 /home/hassan/Documents/nucleusrv/tools/trace/scripts/logToSignature.py --log {testentry['work_dir']}/nucleusrv.log --disass {testentry['work_dir']}/nucleusrv.disass --ref_sig {testentry['work_dir']}/nucleusrv.signature"
                ...
                B = f"cd "
                C = "cd nucleusrv"
                E = 'make sim IMEM={}/nucleusrv.hex'.format(testentry['work_dir'])
                F = f"cd ./tools/trace"
                G = f"echo Generating log..."
                H = "python3 /home/hassan/nucleusrv/tools/trace/scripts/sbtToLog.py --asm {}/nucleusrv.disass --sbt_dump /home/hassan/Downloads/nucleusrv/trace.log --log {}/nucleusrv.log".format(testentry['work_dir'], testentry['work_dir'], testentry['work_dir'])
