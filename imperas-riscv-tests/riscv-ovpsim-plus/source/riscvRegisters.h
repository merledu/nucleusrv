...
#define RISCV_SP                RISCV_CPU_REG(x[RV_REG_X_SP])
...
#define RISCV_CMO               RISCV_CPU_REG(CMO)
#define RISCV_CMO_OFFSET        RISCV_CPU_REG(CMOOffset)
#define RISCV_CMO_BYTES         RISCV_CPU_REG(CMOBytes)
