...
typedef enum riscvExceptionE {
    ...
    riscv_E_NoException                  =  0, // used when C is present
    ...
    // interrupts defined when Sscovpmf is present
    riscv_E_LCOFIInterrupt     = 0xd | riscv_E_Interrupt,
...
typedef enum riscvExceptionPriorityE {
    ...
    riscv_E_LCOFIPriority      = 10,
    riscv_E_UTimerPriority     = 20,
    riscv_E_USWPriority        = 30,
    riscv_E_UExternalPriority  = 40,
    riscv_E_VSTimerPriority    = 50,
    riscv_E_VSSWPriority       = 60,
    riscv_E_VSExternalPriority = 70,
    riscv_E_SGEIPriority       = 80,
    riscv_E_STimerPriority     = 90,
    riscv_E_SSWPriority        = 100,
    riscv_E_SExternalPriority  = 110,
    riscv_E_MTimerPriority     = 120,
    riscv_E_MSWPriority        = 130,
    riscv_E_MExternalPriority  = 140,

    // high-priority local interrupt default priorities when AIA present
    riscv_E_Local40Priority    = 150,
    riscv_E_Local20Priority    = 160,
    riscv_E_Local41Priority    = 170,
    riscv_E_Local42Priority    = 180,
    riscv_E_Local21Priority    = 190,
    riscv_E_Local43Priority    = 200,
    riscv_E_Local44Priority    = 210,
    riscv_E_Local22Priority    = 220,
    riscv_E_Local45Priority    = 230,
    riscv_E_Local46Priority    = 240,
    riscv_E_Local23Priority    = 250,
    riscv_E_Local47Priority    = 260,

    // local interrupt default priorities when AIA absent
    riscv_E_LocalPriority      = 270
