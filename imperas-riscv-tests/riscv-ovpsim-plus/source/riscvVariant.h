...
typedef enum riscvArchitectureE {
    ...
    ISA_NC     = RISCV_FEATURE_BIT(NC_CHAR),
...
typedef enum riscvUserVerE {
    ...
    RVUV_20191213,                      // version 20191213 (identical to 20190305)
...
typedef enum riscvCryptoSetE {
    ...
    RVKS_Zvkb   = (1<<11),              // vector cryptography bit manipulation
    RVKS_Zvkg   = (1<<12),              // GCM/GMAC
    RVKS_Zvknha = (1<<13),              // SHA-256 secure hash
    RVKS_Zvknhb = (1<<14),              // SHA-512 secure hash
    RVKS_Zvkned = (1<<15),              // AES block cipher
    RVKS_Zvksed = (1<<16),              // SM4 instructions
    RVKS_Zvksh  = (1<<17),              // SM3 hash function instructions
...
//
#define RVCLC_MASTER_DATE    "01 August 2023"
#define RVCLC_MASTER_TAG     "97a2d57"
...
typedef enum riscvCLICVerE {
    ...
    RVCLC_DEFAULT = RVCLC_0_9_20230801, // default version
} riscvCLICVer;

//
// Date and tag of AIA master version
//
#define RVAIA_MASTER_DATE    "1 July 2023"
#define RVAIA_MASTER_TAG     "3756b91"
...
typedef enum riscvAIAVerE {
    ...
    RVAIA_DEFAULT = RVAIA_1_0,          // default version
} riscvAIAVer;
...
typedef enum riscvFSModeE {
    ...
    RVFS_EXECUTE_NOT_S,                 // executing FP-non-store instruction sets dirty
    RVFS_EXECUTE_ANY,                   // executing FP instruction sets dirty
    RVFS_ALWAYS_DIRTY,                  // mstatus.FS is always off or dirty
    RVFS_FORCE_DIRTY,                   // mstatus.FS is always dirty
} riscvFSMode;

//
// Supported behavior on illegal PMPCFG write with R=0 W=1
//
typedef enum riscvPMPR0W1E {
...
//
// Date and tag of Sdext/Sdtrig specification
//
#define RVDEBUG_SPEC_DATE   "21 August 2023"
#define RVDEBUG_SPEC_TAG    "83483b1"
...
typedef enum riscvRNMIVerE {
    ...
    RNMI_0_4_NMIE1,                     // RNMI version 0.4, but nmie=1 at reset
