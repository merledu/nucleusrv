...
class ImmediateGen extends Module {
  ...
  when(
    ...
    val ext_i = Cat(Fill(52, imm_i(11)), imm_i)
    io.out := ext_i
  ...
  //U-type
    ...
    .elsewhen(opcode === 99.U) {
      ...
      val ext_sb = Cat(Fill(51, imm_sb(11)), imm_sb, 0.U)
      io.out := ext_sb
    }
    //UJ-type
    .otherwise //(opcode === 111.U)
  {
    ...
    val ext_uj = Cat(Fill(43, imm_uj(19)), imm_uj, 0.U)
    io.out := ext_uj
  }
}
