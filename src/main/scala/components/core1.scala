...
// val valmax = RegInit(0.S(8.W))
// dontTouch(valmax)

// when(instruction(6,0)==="b1010111".U && instruction(14,12)==="b111".U && (instruction(31)==="b0".U || instruction(31,30)==="b11".U)){

//   lmul := instruction(22,20)  //011
//   vtype := instruction(30,20)
//   vsew := instruction(25,23)
//   val y0 = !lmul(1) && !lmul(0) || lmul(2)  //0&&0||0 = 0
//   val y1 = !lmul(2) && !lmul(1) && lmul(0)  //1&&0||1 = 1
//   val y2 = !lmul(2) && lmul(1) && !lmul(0)  // 1&&1&&0 = 0
//   val y3 = !lmul(2) && lmul(1) && lmul(0)   //1&&1&&1 = 1
//   val lmul_o = Cat(y3, y2, y1, y0)  //1010
//   dontTouch(lmul_o)
//   when(vsew === "b000".U){  //sew=8
//       valmax := Cat(lmul_o, 0.U(4.W)).asSInt
//   }.elsewhen(vsew === "b001".U){ //sew=16
//     valmax := Cat(lmul_o, 0.U(3.W)).asSInt
//   }.elsewhen(vsew === "b010".U){ //sew=32
//       valmax := Cat(lmul_o, 0.U(2.W)).asSInt
//   }.elsewhen(vsew ==="b011".U){ //sew=64
//       valmax := Cat(lmul, 0.U(1.W)).asSInt
//   }
// }
// .otherwise{
//   lmul := lmul
