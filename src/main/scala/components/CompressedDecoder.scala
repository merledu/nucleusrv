...
class CompressedDecoder extends Module {
    ...
    is ("b01".U) {
      ...
      switch (instruction_i(15, 13)) {
        ...
        is ("b011".U) {
          ...
          io.is_comp := true.B
          io.instruction_o := Cat(Fill(15,instruction_i(12)), instruction_i(6,2), instruction_i(11,7), OPCODE_LUI)
          
          when(instruction_i(11,7) === "h02".asUInt(5.W)) {
            // c.addi16sp -> addi x2, x2, nzimm
             io.instruction_o := Cat(Fill(3,instruction_i(12)), instruction_i(4,3), instruction_i(5), instruction_i(2),
                                  instruction_i(6), "b0000".asUInt(4.W), "h02".asUInt(5.W), "b000".asUInt(3.W), "h02".asUInt(5.W), OPCODE_OP_IMM)
          }
        }
        ...
        is ("b100".U) {    
          ...
          switch (instruction_i(11,10)) {
            ...
            is ("b10".U) {
              ...
              io.is_comp := true.B
              io.instruction_o := Cat(Fill(6,instruction_i(12)), instruction_i(12),instruction_i(6,2), "b01".asUInt(2.W), instruction_i(9,7),
                                  "b111".asUInt(3.W),"b01".asUInt(2.W), instruction_i(9, 7), OPCODE_OP_IMM)
            }
        ...
        is ("b10".U) {
          ...
          when(instruction_i(12) === "b0".U ) {
            ...
            when(instruction_i(6,2) =/= "b0".asUInt(5.W)) {
              ...
              io.is_comp := true.B
              io.instruction_o := Cat(Fill(12,"b0".U), instruction_i(11,7),Fill(8,"b0".U), OPCODE_JALR)
            }
          } .otherwise {
            ...
            when(instruction_i(6,2) =/= "b0".asUInt(5.W)) {
              ...
              when(instruction_i(11,7) === "b0".asUInt(5.W)) {
                // c.ebreak -> ebreak
                io.is_comp := true.B
                ...
                io.is_comp := true.B
                io.instruction_o := Cat(Fill(12,"b0".U), instruction_i(11,7),Fill(7,"b0".U), "b1".U, OPCODE_JALR)
              }
            }
          }
        }
  ...
  when(instruction_i === "h0".asUInt(32.W)){
    // illegal instruction
      io.is_comp := false.B
      io.instruction_o := instruction_i
  }
